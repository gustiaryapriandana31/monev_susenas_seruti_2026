...
class DataDsslsImport extends DefaultValueBinder implements ToModel, WithHeadingRow, WithValidation, WithCustomValueBinder
{
    ...
    */
    public function model(array $row)
    {
        ...
        return new DataDssls([
            ...
            'jumlah_keluarga_awal' => $row['jumlah_keluarga_awal'] ?? null,
            'jumlah_keluarga_hasil_updating' => $row['jumlah_keluarga_hasil_updating'] ?? null,
            'jumlah_rumah_tangga_hasil_updating' => $row['jumlah_rumah_tangga_hasil_updating'] ?? null,

...
class PetugasEntryImport implements ToModel, WithHeadingRow, WithValidation
{
    ...
    */
    ...
    {
        return [
            'kode_petugas' => 'unique:petugas_entries,kode_petugas',
        ];
    }
    ...
    {
        return [
            'kode_petugas.unique' => 'Data petugas entry dengan kode ini sudah ada di sistem. Gagal import duplikat.',
        ];
    }
}
